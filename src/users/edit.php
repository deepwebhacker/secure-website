...
$inputValues = array('token' => '', 'id' => '', 'username' => '', 'email' => '', 'activated' => '', 'banned' => '', 'role' => '');
$errorMessages = array('global' => '', 'uri' => '', 'token' => '', 'id' => '', 'username' => '', 'email' => '', 'password' => '', 'confirmPassword' => '', 'role' => '');
$uniqueValues = array('username' => '', 'email' => '');
$uriError = false;
if (isset($_GET['id'])) {
    ...
    if (isset($_SERVER['REQUEST_METHOD'])) {
        if (strtolower($_SERVER['REQUEST_METHOD']) === 'post') {
            if (isset($_POST['token']) && isset($_POST['id']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmPassword']) && isset($_POST['role'])) {
                ...
                $parameters = array('token' => trim($_POST['token']), 'id' => trim($_POST['id']), 'username' => trim($_POST['username']), 'email' => trim($_POST['email']), 'password' => $_POST['password'], 'confirmPassword' => $_POST['confirmPassword'], 'activated' => isset($_POST['activated']), 'banned' => isset($_POST['banned']), 'role' => trim($_POST['role']));
